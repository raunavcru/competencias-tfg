# Generated by Django 3.1.4 on 2021-01-07 12:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_weight', models.DecimalField(decimal_places=2, max_digits=3, verbose_name='subject_weight')),
                ('weight', models.DecimalField(decimal_places=2, max_digits=3, verbose_name='weight')),
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='competence_parent', to='corrigeapp.competence')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='evaluation_parent', to='corrigeapp.evaluation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students', models.ManyToManyField(related_name='student', to='corrigeapp.Student', verbose_name='students_set')),
