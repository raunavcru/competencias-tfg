...
urlpatterns = [
    ...
    path('marks/competences/<int:id>/<int:pk>/exercise/next', views.MarkCompetenceNextExerciseView.as_view(), name = 'marks_competences_exercise_next'),
    path('marks/competences/<int:id>/<int:pk>/exercise/previous', views.MarkCompetencePreviousExerciseView.as_view(), name = 'marks_competences_exercise_previous'),
