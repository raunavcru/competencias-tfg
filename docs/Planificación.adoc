...
En cada celda se mostrará el nombre de la tarea o el caso de uso y la fecha en la que debe estar finalizada la tarea entre corchetes.

Los _Sprints_ son los siguintes:

* Sprint 1: 1 de Enero al 28 de Enero. Véase xref:Table 1[Planificación Sprint 1]
