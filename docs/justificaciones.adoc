...
|Alternativa
|La segunda opción es Jekins. El mayor ventaja que podemos destacar de Travis frente Jenkins es no qué necesita ningún tipo de instalación, solo se configura un solo archivo y se puede utilizar a la perfección.
|===
