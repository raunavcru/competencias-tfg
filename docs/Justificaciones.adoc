...
El resto de aplicaciones usadas durante el desarrolo fue elegido por que queríamos usar entornos lo más parecidos a la realidad posibles. A causa de esto elegimos Jira, ya que es una aplicación web para la gestión de trabajo, y esta especializada en metodologías ágiles, algo que ibamos a usar para el desarrollo.
