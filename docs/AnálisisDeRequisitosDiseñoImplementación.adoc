...
Nos decantamos por la Fuente Ubuntu, la cual obtuvimos de su página Web [].
...
Nos decantamos por la web **Unsplash** [], la cual tiene un gran número de imágenes muy útiles, y una licencia que nos permitía lo nombrado anteriormente.
...
Para más información puede consultar dicha licencia en la página Web de Unsplash [].
