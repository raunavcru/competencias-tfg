...
Este tipo de requisito se basa en la definición de una funcionalidad del sistema o los componentes software. Esta, debe tener en cuenta las entradas y las salidas.
...
1. El administrador desea crear un grupos de clase.
...
1. El administrador desea eliminar un grupos de clase.
...
=== III.V Justificaciones de las tecnologías y herramientas utilizadas
...
En cuanto a la búsqueda del lenguaje de programación a usar, ambos lo tuvimos claro. Sabíamos del potencial de Python para el uso de aplicaciones web. El conocimiento del lenguaje por parte del grupo era dispar, puesto que uno de nosotros, apenas conocía el lenguaje. A sabiendas de que en una de las asignaturas que se imparte en el último año de la carrera se iba a utilizar el framework de Django, no dudamos en elegirlo.

El resto de aplicaciones usadas durante el desarrollo fue elegido por que queríamos usar entornos lo más parecidos a la realidad posibles. A causa de esto elegimos Jira, ya que es una aplicación web para la gestión de trabajo, y esta especializada en metodologías ágiles, algo que íbamos a usar para el desarrollo.
...
* **X**: Versión mayor.
* **Y**: Versión menor.
* **Z**: Versión ene el que se solventan _bugs_ de la versión anterior.
...
=== III.IIX Fuentes e Imágenes

El apartado visual dentro de una aplicación web se le conoce como el frontend, este tiene muchos factores, el color, la forma, las imágenes, etc. En nuestro caso le pusimos mucho hincapié a todo esto, pero especialmente al apartado de las imágenes y la fuente. 
...
La opción a la hora de seleccionar las imágenes para la web fue difícil, ya que buscábamos un banco de imágenes que nos permitiera el uso comercial pensando en un hipotética uso de la misma y sin derechos de autor.

===== III.IIX.II.I Elección
...
Para internacionalizar las vistas utilizamos las etiqueta _trans_ sobre la palabra o conjunto de palabras que queremos traducir.
...
Para crear dicho archivo y compilarlo debemos utilizar los siguientes comando:
